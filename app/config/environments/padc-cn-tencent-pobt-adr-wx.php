...
/**
 * #PADC#
 * TencentPOBT（AndroidWechat用）環境定数.
 */
class Env extends AllEnv
{
	const ENV = 'tencentpobtadrwx';
	...
	// Midas
	const MIDAS_APPKEY_IOS	= 'WMb75sLZgNVrqL5gX1X12lumhSGSMgyT';
	const MIDAS_ZONEID_ADR = 101;
